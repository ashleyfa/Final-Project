<?php
    $page_title = "Women - Downtown Fashion";
    $navmenu = array(
            "Home"=> "../../home/",
            "Shop"=>"../../shop",
            "Men"=>"../men",
            ...
            <div class = "row">
                ...
                <div class ="col-md-10 col-xs-12 col-sm-10">
                    <?php 
                        ...
                        $sql = "SELECT COUNT(*) FROM women_product";
                        ...
                        $sql = "SELECT id, name, price, url, description FROM women_product LIMIT $offset, $rowlimit";
                        $result = mysqli_query($conn, $sql) or trigger_error("SQL", E_USER_ERROR);
                    ?>
                    ...
                    while($list = mysqli_fetch_assoc($result)){
                        ...
                        echo "<a href='../../shop/product.php?category=product&id=".$list['id']."'><img class = 'product_img' src=".$list['url']."></a>";
