...
<head>
    ...
    <script src="../../js/passtest.js"></script>
</head>
<div class ="wrapper">
    <div id ="header_desc">
        <div class="container">
        ...
        <!-- Begin page content -->
    <div id = "cart-login-wrapper">
        <div class = "container">
            <div class="cartloginpadding">
                <div class ="row">
                    ...
                    <div class="col-xs-12 col-sm-4 newuser">
                        <h4>New Users</h4>
                    ...
                    <div class="col-xs-12 col-sm-4 shoppingbag">
                    </div>
                </div>
            </div>
        </div>
